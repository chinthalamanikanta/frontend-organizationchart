    ...
    const fetchData = async () => {
      try {
        ...
        const [originResponse] = await Promise.all([
          axios.get(`https://maniorganizationsheet-dufjh2b8drcgh0hq.canadacentral-01.azurewebsites.net/api/employees/origin/${employeeId}`)
        ]);
      ...
      try {
        ...
        const [ employeesResponse] = await Promise.all([
          axios.get("https://maniorganizationsheet-dufjh2b8drcgh0hq.canadacentral-01.azurewebsites.net/api/employees")
        ]);
      ...
      try {
        ...
        const [ reportingResponse] = await Promise.all([
          axios.get(`https://maniorganizationsheet-dufjh2b8drcgh0hq.canadacentral-01.azurewebsites.net/api/employees/reporting-to/${employeeId}`)
        ]);
